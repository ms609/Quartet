...
**Priority:** P0 = blocking / critical bug · P1 = next objective or
correctness · P2 = important · P3 = nice-to-have
...
T-005 \| P2 \| COMPLETE \| A \| OpenMP parallelism: one-to-many and
pairs loops \| Parallelised `oneToManyQuartetAgreement` and
`pairs_quartet_distance`. C++ speedup: 4.6× at 400 tips. \|
