...
#for (i in seq_along(trs)) colplot(trs[[i]], names(trs)[i])
...
## Plotting this data
We can use a ternary plot to visualise this data.
The horizontal lines link points with an equal KL divergence.
I'll explain this soon.

```{R Plot some trees, fig.width=8, fig.height=4, echo=FALSE}
par(mfrow=c(1, 2), mar=rep(0.3, 4))
TernaryPlot(grid.lty='solid', col=rgb(0.9, 0.9, 0.9), grid.col='white', padding=0.18)
HorizontalGrid()
