...
rfplot <- function (tr, title, highlight=NULL, ref=ref_tree) {
  ...
  text(text_x,  9.6, paste0("RF = ", topo_dist, '/', rf_max), cex=0.8, pos=4)
...
The RF distance can be modified in a similar fashion to give the number of 
partitions contradicted / unresolved.
...
polyplot <- function (tr, title, highlight) {
  ...
  text(text_x,  8.6, paste0("Partitions contradicted = ", topo_dist - unresolved, '/', rf_max), cex=0.8, pos=4)
  text(text_x,  7.6, paste0("Partitions unresolved = ", unresolved, '/', rf_max), cex=0.8, pos=4)
}
