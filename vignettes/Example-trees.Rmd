...
polyplot <- function (tr, title, highlight, ...) {
  ...
  text(x_mid, -0.5, cex=0.8, pos=4, paste0(sum(MatchingQuartets(tree_pair)['d', 2]), '/', choose(11,4)))
  text(x_mid, -1.5, cex=0.8, pos=4, paste0(sum(MatchingQuartets(list(tr, ref_tree))[c('r1','r2','u'), 2]), '/', choose(11,4)))
...
I propose a fifth metric, which is analogous to both the partition metric and the 
