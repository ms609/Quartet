...
legend('bottomright', cex=0.8, bty='n',
       pch=c(PCH_MK, PCH_EQ, rep(PCH_IW, 5)), pt.cex=1.1,
       col=c(COL_MK, COL_EQ, COL_2, COL_3, COL_5, COL10),
       legend=c('Markov', 'Equal weights', paste0('Implied, k=', c(2, 3, 5, 10)))
)
