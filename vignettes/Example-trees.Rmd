...
Here I have taken a dataset simulated from a 22-tip reference tree [@Congreve2016],
...
at leaast $x$ at 20 uniformly spaced values of $x$ from 0.5 to 1.0.
...
```{R Congreve Lamsdell tree, fig.height=3, fig.width=9, echo=FALSE}
...
legend('bottomright', cex=0.8, bty='n',
       ...
       col=c(COL_MK, COL_EQ, COL_1, COL_3, COL_5),
       legend=c('Markov', 'Equal weights', paste0('Implied, k=', c(1, 3, 5)))
)
