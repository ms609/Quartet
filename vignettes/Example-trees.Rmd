...
PlotQuartet(trees7, LETTERS[1:4], cex=1.8)
```
...
An equivalent metric can be generated using partitions, but is subject to all the
...
The quartet distance is the only available metric of tree distance that fulfills 
