...
TernaryBasis <- function (qMax = 19, zoom = 1) {
  ...
  TernaryPlot(lab[1], lab[2], lab[3], lab.cex=0.8, lab.font=2,
              ...
              padding=0.1, xlim=xLim, ylim=yLim)
...
TernaryPlot('Same', 'Different', 'Unresolved', lab.cex=0.8,
            grid.lines = 19, grid.lty='solid', col=rgb(0.9, 0.9, 0.9), grid.col='white', 
