...
The number of quartets or partitions that are unresolved, different, or identical to the refernece tree can be visualized using ternary diagrams:
...
$\textrm{Character penalty} = \frac{e}{e + k}$
