...
### Partition metric
The Robinson-Foulds (RF, 'partition' or 'symmetric difference') [@Robinson1981, @Steel1993]
metric adds the number of bipartitions that are present in tree A (but not tree B)
...
For a quartet, in two trees, there are five possibilities [@Estabrook1985]:
...
Otherwise:
 3. Unresolved in **T**ree **1** only
 4. Unresolved in **T**ree **2** only
 5. **U**nresolved in both trees
