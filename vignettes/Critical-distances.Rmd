...
PlotApeTree <- function (text, quartet) {
  orig <- TreeTrunk::RenumberTips(tree_c, as.character(1:6))
  tree <- ape::read.tree(text=text)
  PlotQuartet(list(orig, TreeTrunk::RenumberTips(tree, as.character(1:6))), quartet, overwritePar=FALSE, cex=0.9)
}
