...
```{R Move-a-cherry-two, eval=FALSE, echo=FALSE, fig.align='center', fig.height=4, fig.width=6.4, message=FALSE, cache=TRUE, out.width='66%'}
par(mfrow=c(1, 3), mar=c(2.4, 0.4, 0.4, 0.4), cex=1)
...
```{R Move-vs-exchange, echo=FALSE, message=FALSE, cache=TRUE, fig.width=6.4, fig.aspect=2/5, fig.align='center'}
...
```{R Pectinate-to-break-RF, echo=FALSE, message=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.align='center'}
