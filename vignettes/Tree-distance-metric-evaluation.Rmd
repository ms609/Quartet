...
library('TreeSearch') # TODO delete?
library('TreeDist') # TODO delete?
library('Quartet')
...
RFPlot <- function (tr, title=NULL, highlight=NULL, ref=sq_trees[[1]], 
  ...
  text(text_x, y <- y - 1, paste0(
    signif(TreeDist::VariationOfArborealInfo(tr, ref), 4), ' / ', pair_info
    ), cex=0.8, pos=4)
  ...
  #text(text_x, y <- y - 1, paste0(100 * signif(TreeDist::VariationOfPartitionInfo(tr, ref) / pair_info, 4), '%'), cex=0.8, pos=4)
}
```
...
random_arb_info <- TreeDist::VariationOfArborealInfo(random_trees, pectinate_tree)
pect_arb_info <- TreeDist::VariationOfArborealInfo(pectinate_move1, pectinate_tree)
#random_par_info <- TreeDist::VariationOfPartitionInfo(random_trees, pectinate_tree)
#pect_par_info <- TreeDist::VariationOfPartitionInfo(pectinate_move1, pectinate_tree)
pect_arb_info <- TreeDist::VariationOfArborealInfo(pectinate_move1, pectinate_tree)
random_clu_info <- TreeDist::VariationOfClusteringInfo(random_trees, pectinate_tree)
pect_clu_info <- TreeDist::VariationOfClusteringInfo(pectinate_move1, pectinate_tree)
random_ms_info <- TreeDist::MatchingSplitDistance(random_trees, pectinate_tree)
pect_ms_info <- TreeDist::MatchingSplitDistance(pectinate_move1, pectinate_tree)
random_nye_info <- 8L - TreeDist::NyeTreeSimilarity(random_trees, pectinate_tree)
pect_nye_info <- 8L - TreeDist::NyeTreeSimilarity(pectinate_move1, pectinate_tree)
