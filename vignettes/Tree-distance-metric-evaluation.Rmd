...
RFPlot <- function (tr, title=NULL, highlight=NULL, ref=sq_trees[[1]], ...) {
  ...
  text(text_x, y <- y - 1, paste0(signif(TreeSearch::MatchingSplitDistance(tr, ref), 4), '/16'), cex=0.8, pos=4)
  text(text_x, y <- y - 1, paste0(signif(TreeSearch::NyeTreeSimilarity(tr, ref), 4), '/8'), cex=0.8, pos=4)
  text(text_x, y <- y - 1, signif(TreeSearch::MutualClusterInfo(tr, ref), 4), cex=0.8, pos=4)
  text(text_x, y <- y - 1, signif(TreeSearch::MutualArborealInfo(tr, ref), 4), cex=0.8, pos=4)
  text(text_x, y <- y - 1, signif(TreeSearch::VariationOfArborealInfo(tr, ref), 4), cex=0.8, pos=4)
}
...
random_arb_info <- TreeSearch::MutualArborealInfo(random_trees, pectinate_tree)
random_clu_info <- TreeSearch::MutualClusterInfo(random_trees, pectinate_tree)
...
pect_arb_info <- TreeSearch::MutualArborealInfo(pectinate_move1, pectinate_tree)
...
pect_clu_info <- TreeSearch::MutualClusterInfo(pectinate_move1, pectinate_tree)
