...
RFPlot <- function (tr, title=NULL, highlight=NULL, ref=sq_trees[[1]], ...) {
  ...
  text(text_x, y <- y - 1, "MPhyInf:", cex=0.8, pos=2)
  text(text_x, y <- y - 1, "VoPhyInf:", cex=0.8, pos=2)
