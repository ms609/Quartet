...
RFPlot <- function (tr, title=NULL, highlight=NULL, ref=sq_trees[[1]], 
  ...
  text(text_x, y <- y - 1, paste0(8-signif(TreeSearch::NyeTreeSimilarity(tr, ref), 4), '/8'), cex=0.8, pos=4)
...
| **Measure** | MArInf | MPaInf | Nye _et al._ | MS | Quartet | Path | SPR | RF |
| ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | 
| **Outcome** | `r pass` | `r pass` | `r pass` | `r FAIL` | `r pass` | `r pass` | `r FAIL` | `r pass` |
...
| **Measure** | MArInf | MPaInf | Nye _et al._ | MS | Quartet | Path | SPR | RF |
| ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | 
| **Single-node move** | `r pass` | `r pass` | `r pass` | `r pass` | (?) | `r pass` | `r FAIL` | `r FAIL` |
...
| **Measure** | MArInf | MPaInf | Nye _et al._ | MS | Quartet | Path | SPR | RF |
| ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | 
| **Two node move** | `r pass` | `r pass` | `r FAIL` | `r FAIL` | `r pass` | `r pass` | `r FAIL` | `r FAIL` |
<!--
...
| **Measure** | MArInf | MPaInf | Nye _et al._ | MS | Quartet | Path | SPR | RF |
| ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | 
| **Exchange two tips** | `r pass` | `r pass` | `r pass` | `r pass` | `r pass` | `r pass` | `r pass` | `r FAIL` |
...
| **Measure** | MArInf | MPaInf | Nye _et al._ | MS | Quartet | Path | SPR | RF |
| ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | 
| **Complexity** | `r pass` | `r pass` | `r pass` | `r pass` | `r pass` | `r FAIL` | `r pass` | `r FAIL` |
...
```{R Pectinate-to-break-RF, echo=FALSE, fig.align='center', fig.width=6.4, message=FALSE, cache=TRUE, out.width='66%'}
par(mfrow=c(2, 2), mar=rep(0.4, 4), cex=1)
...
| **Measure** | MArInf | MPaInf | Nye _et al._ | MS | Quartet | Path | SPR | RF |
| ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | 
| **Saturation** | `r pass` | `r pass` | `r pass` | `r pass` | `r pass` | `r pass` | (?) | `r FAIL` |


```{R generate-random-trees, include=FALSE}
n_random <- if (Sys.getenv('TRAVIS') == "") 2500 else 10
n_random_tips <- 11
...
random_ms_info <- TreeSearch::MatchingSplitDistance(random_trees, pectinate_tree)
pect_ms_info <- TreeSearch::MatchingSplitDistance(pectinate_move1, pectinate_tree)
random_nye_info <- 8L - TreeSearch::NyeTreeSimilarity(random_trees, pectinate_tree)
pect_nye_info <- 8L - TreeSearch::NyeTreeSimilarity(pectinate_move1, pectinate_tree)
...
PlotHist(random_distances['path.difference', ], breaks=manyBreaks *
           max(random_distances['path.difference', ]), 17.7, "Path distance")

PlotHist(random_spr[1, ], max(random_spr[1, ]) * manyBreaks, 1, 'SPR distance')

PlotHist(random_distances['symmetric.difference', ] / 16, manyBreaks, 1, 'Robinson-Foulds')

plot.new()
legend('topleft', bty='n', col=cbPalette8[3], lwd=2, 'One tip moved\n maximum distance', cex=0.8)
...
| **Measure** | MArInf | MPaInf | Nye _et al._ | MS | Quartet | Path | SPR | RF |
| ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | 
| **Polytomies** | `r pass` | `r pass` | `r pass` | `r pass` | `r pass` | `r FAIL` | `r FAIL` | `r pass` |
