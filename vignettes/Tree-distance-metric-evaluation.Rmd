...
RFPlot <- function (tr, title=NULL, highlight=NULL, ref=sq_trees[[1]], 
  ...
  text(text_x, y <- y - 1, paste0(signif(tree_dist['path.difference'], 3)), cex=0.8, pos=4)
...
```{R Move-a-cherry-two, echo=FALSE, message=FALSE, cache=TRUE, fig.width=6, fig.height=4, out.width='66%', fig.align='center'}
par(mfrow=c(1, 3), mar=c(2.4, 0.4, 0.4, 0.4), cex=1)
...
```{R  Move-a-cherry-two-b, echo=FALSE, message=FALSE, cache=TRUE, fig.width=6, fig.height=4, out.width='66%', fig.align='center'}
par(mfrow=c(1, 3), mar=c(2.4, 0.4, 0.4, 0.4), cex=1)
...
```{r root-location, echo=FALSE, cache=TRUE, warn=FALSE, message=FALSE, fig.height=6, fig.width=5.6, out.width='80%', fig.align='center'}
par(mfrow=c(1, 3), mar=c(2.4, 0.4, 0.4, 0.4), cex=1)

RFPlot(pectinate_tree, ref=pectinate_tree, 'Pectinate tree')

RFPlot(ape::root(pectinate_move1, c('1', '11', '10', '9', '8', '7'), resolve.root=TRUE), ref=pectinate_tree, 'Pectinate tree')
...
```{r, echo=FALSE, cache=TRUE, warn=FALSE, message=FALSE, fig.height=6, fig.width=5.6, out.width='80%', fig.align='center'}
par(mfrow=c(1, 3), mar=c(2.4, 0.4, 0.4, 0.4), cex=1)

RFPlot(pectinate_tree, 'Pectinate tree')

#RFPlot(pectinate_move1, 'Move one taxon', 1, ref=pectinate_tree, edge.lengths = c(rep(1, 4), #2, rep(1, 12), .5, .5, 1.5))

RFPlot(ape::read.tree(text='(((((1, 5), 2), 6), (3, 4)), ((8, (7, 9)), (10, 11)));'), 'Short shuffle', ref=pectinate_tree)

RFPlot(ape::read.tree(text='(((8, (7, 9)), (10, 11)), ((((1, 5), 2), 6), (3, 4)));'), 'Short shuffle re-root', ref=pectinate_tree)

#shortPaths <- which(random_distances['path.difference', ] < 17.7)
#RFPlot(random_trees[[max(shortPaths)]], ref=pectinate_tree)
