...
load_all('c:/research/r/TreeSearch')
library('Quartet')
...
RFPlot <- function (tr, title=NULL, highlight=NULL, ref=sq_trees[[1]], ...) {
  ...
  text(text_x, y <- y - 1, paste0(signif(TreeSearch::MatchingSplitDistance(tr, ref), 4)), cex=0.8, pos=4)
  text(text_x, y <- y - 1, paste0(signif(TreeSearch::NyeTreeSimilarity(tr, ref), 4)), cex=0.8, pos=4)
  text(text_x, y <- y - 1, paste0(signif(TreeSearch::MutualClusterInfo(tr, ref), 4)), cex=0.8, pos=4)
  text(text_x, y <- y - 1, paste0(signif(TreeSearch::MutualArborealInfo(tr, ref), 4)), cex=0.8, pos=4)
  text(text_x, y <- y - 1, paste0(signif(TreeSearch::VariationOfArborealInfo(tr, ref), 4)), cex=0.8, pos=4)
}
...
random_arb_info <- TreeSearch::MutualArborealInfo(random_trees, more_random_trees)
