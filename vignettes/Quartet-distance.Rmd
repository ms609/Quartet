...
```{r Add tip 6, fig.height=2, fig.width=2, echo=FALSE}
par(mar=rep(0.3, 4))
...
```{r Cannot add tip 6, fig.height=4, fig.width=8, echo=FALSE}
...
vapply(4:20, function (n_tip) {
 trees <- lapply(logical(2000), function (X) ape::rtree(n_tip, tip.label=seq_len(n_tip), br=NULL))
