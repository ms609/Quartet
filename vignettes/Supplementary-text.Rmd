...
code used to generate figures and conduct analyses, and is provided in the Electronic Supplementary Material that accompanies the main article.
...
At progressively smaller values of _k_, a single character must exhibit increasingly more steps before it is afforded the same penalty.
