...
rfplot <- function (tr, title=NULL, highlight=NULL, ref=ref_tree, ...) {
  ...
  text(text_x, -0.5, paste0(MatchingQuartets(list(tr, ref))[2, 'd'],
...
polyplot <- function (tr, title, highlight, ...) {
  ...
  text(x_mid, -0.5, cex=0.8, pos=4, 
       paste0(MatchingQuartets(tree_pair)[2, 'd'], '/', choose(11, 4)))
  text(x_mid, -1.5, cex=0.8, pos=4, 
       paste0(sum(MatchingQuartets(tree_pair)[2, c('r1','r2','u')]), '/', choose(11, 4)))
