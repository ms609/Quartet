...
BLANK_SCORES <- array(NA, c(6, 21, length(FILE_NUMS)), dimnames=list(c( "Q",  "s", "d", "r1", "r2", "u"), NULL, FILE_NUMS))
ALL_BLANKS <- lapply(ANALYSES, function(x) BLANK_SCORES)
names(ALL_BLANKS) <- ANALYSES
if (!exists("orPartitions")) orPartitions <- list('100'=ALL_BLANKS, '350'=ALL_BLANKS, '1000'=ALL_BLANKS)
if (!exists("orQuartets")) orQuartets <- list('100'=ALL_BLANKS, '350'=ALL_BLANKS, '1000'=ALL_BLANKS)
